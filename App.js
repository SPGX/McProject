...
const { NAiBModule } = NativeModules;
class FirstScreen extends Component {
  constructor() {
    ...
    if(Platform.OS === 'android'){
        ...
        AppName = "NAiReact 0.2.1302 (Android)";
    }else if(Platform.OS === 'ios'){
        // iOS-specific code/UI Component
        AppName = "NAiReact 0.2.1302 (iOS)";
    }
  ...
  async buttonRead() {
    ...
    await sleep(1) //for screen refreshing.
    ...
    text_result = text_result + "\nRead Text+Photo: "+ Time_ReadPhoto.toFixed(2) + " s"
    this.setState({
      text_result: text_result,
    });
    this.EnableButton();
  ...
  //////////////////////////////// Get File Directory ////////////////////////////////
  async getFilesDirJF(){
      var FilesDirectory = await NAiBModule.getFilesDirBM();
  ...
  //////////////////////////////// Set Listener ////////////////////////////////
  async setListenerJF(){
    var response = await NAiBModule.setListenerBM();
  ...
  async writeLicFileJF() {
    var returnCode = await NAiBModule.writeLicFileBM(LicFile);
    if (isNaN(returnCode)) {
      returnCode = Number.parseInt(returnCode);
    }
    if (returnCode == 1) {
  ...
  async setPermissionsJF() {
    var pms = 1;
    var returnCode = await NAiBModule.setPermissionsBM(pms);
    if (isNaN(returnCode)) {
      // if is not a number
      returnCode = Number.parseInt(returnCode);
    }
  ...
  async openLibJF() {
    resOpenLib = "";
    var returnCode = await NAiBModule.openLibBM(Parameter_OpenLib)
    if (isNaN(returnCode)) {
      returnCode = Number.parseInt(returnCode);
    }
    if (returnCode == NA_SUCCESS) {
  ...
  async getReaderListJF () {
    ...
    if(Platform.OS === 'android'){
      ...
      result = await NAiBModule.getReaderListBM(listOption);
    }else if(Platform.OS === 'ios'){
      result = await NAiBModule.getReaderListBM();
    }
  ...
  async selectReaderJF(textReaderName) {
    returnCode = await NAiBModule.selectReaderBM(textReaderName)
    if (isNaN(returnCode)) {
      returnCode = Number.parseInt(returnCode);
    }
    if (returnCode != NA_SUCCESS) {
  ...
  async getReaderInfoJF() {
    var readerInfo = "";
    var res = await NAiBModule.getReaderInfoBM();
  ...
  //////////////////////////////// Connect Card ////////////////////////////////
  async connectCardJF() {
    res = await NAiBModule.connectCardBM();
    return res;
  }

  //////////////////////////////// Get NID Number ////////////////////////////////
  async getNIDNumberJF(){
    var res = await NAiBModule.getNIDNumberBM();
    var tempRes = res.split(";");
    return tempRes;
  }
  ...
  //////////////////////////////// Get Text ////////////////////////////////
  async getTextJF(){
    var res = await NAiBModule.getTextBM();
    var tempRes = res.split(";");
    return tempRes;
  }
  ...
  //////////////////////////////// Get Photo ////////////////////////////////
  async getPhotoJF(){
    var res = await NAiBModule.getPhotoBM();
    var tempRes = res.split(";");
    return tempRes;
  }
  ...
  async disconnectCardJF() {
    returnCode = await NAiBModule.disconnectCardBM();
    return returnCode;
  }

  //////////////////////////////////// Deselect Reader ////////////////////////////////////
  async deselectReaderJF() {
    var returnCode = await NAiBModule.deselectReaderBM();
    return returnCode;
  }

  //////////////////////////////// Update License ////////////////////////////////
  async updateLicenseFileJF() {
    var returnCode = await NAiBModule.updateLicenseFileBM();
    return returnCode;
  }

  //////////////////////////////// Get Card Status ////////////////////////////////
  async getCardStatusJF() {
      returnCode = await NAiBModule.getCardStatusBM();
      return returnCode;
  }
  ...
  async getReaderIDJF() {
      ...
      var res = await NAiBModule.getReaderIDBM();
      var tempRes = res.split(";");
      return tempRes;
  }
  ...
  async getSoftwareInfoJF(){
    var resSoftwareInfo = await NAiBModule.getSoftwareInfoBM();
    this.setState({
  ...
  async getLicenseInfoJF( ){
    var resLicenseInfo = await NAiBModule.getLicenseInfoBM();
    this.setState({
  ...
  //////////////////////////////////// Close Lib ////////////////////////////////////
  async closeLibJF() {
    returnCode = NAiBModule.closeLibBM();
    return returnCode;
  }
